...
# Lambda Function
resource "aws_lambda_function" "merge_transcripts" {
...
resource "aws_lambda_function_url" "merge_url" {
  count              = var.enable_function_url ? 1 : 0
  function_name      = aws_lambda_function.merge_transcripts.function_name
...
resource "aws_cloudwatch_metric_alarm" "lambda_errors" {
  ...
  dimensions = {
    FunctionName = aws_lambda_function.merge_transcripts.function_name
  }
}
...
resource "aws_cloudwatch_metric_alarm" "lambda_duration" {
  ...
  period             = "300"
  statistic          = "Average"
  threshold          = var.lambda_timeout * 1000 * 0.9  # 90% of timeout in ms
