"""
HTTP server wrapper for chunking Lambda function.
...
def health():
    ...
    return jsonify({"status": "healthy", "service": "chunking-lambda"})
...
if __name__ == '__main__':
    ...
    logger.info(f"Starting chunking-lambda HTTP server on port {port}")
